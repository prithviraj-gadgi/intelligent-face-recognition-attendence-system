                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            if buttonReply == QMessageBox.Yes:
                                ...
                                date_time_string = datetime.datetime.now().strftime("%d/%m/%Y %I:%M:%S %p")
                    ...
                    if field in row:
                        if field == 'Clock In':
                            if row[0] == name:
                                ...
                                Time1 = (datetime.datetime.strptime(row[1], '%d/%m/%Y %I:%M:%S %p'))
                                self.TimeList1.append(Time1)
                        if field == 'Clock Out':
                            if row[0] == name:
                                #print(f'\t ROW 0 {row[0]}  ROW 1 {row[1]} ROW2 {row[2]}.')
                                Time2 = (datetime.datetime.strptime(row[1], '%d/%m/%Y %I:%M:%S %p'))
